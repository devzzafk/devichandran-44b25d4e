      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-16">
          {services.map((service, index) => (
            <Card 
              key={service.title}
              className="skill-card group p-8 bg-card-gradient border-0 shadow-soft hover:shadow-hover"
        ...
        <div className="slide-up">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            {tutorialHighlights.map((highlight, index) => (
              <div 
                key={highlight.title}
            ...
            <Card className="inline-block p-8 bg-card-gradient border-0 shadow-soft">
              <CardContent className="p-0">
                ...
                <p className="text-muted-foreground mb-6 max-w-md">
                  Join hundreds of students who have enhanced their coding and design skills 
                  through my comprehensive tutorial programs.
                </p>
                <Button 
                  onClick={scrollToContact}
                  size="lg"
